...
const InvProdList = (props: any) => {
  ...
  const requestSort = (
    ...
    setSortConfig({ key, secondaryKey, tertiaryKey, direction });
  };
            ...
            <ul>
              <li>
                <button
                  ...
                  onClick={() => {
                    requestSort("productActive", "onSale", "organic", "normal");
                    setButtonActive("1");
                  }}
                >
                  Active/Inactive
              ...
              <li>
                <button
                  ...
                  onClick={() => {
                    requestSort("productActive", "organic", "onSale", "normal");
                    setButtonActive("2");
                  }}
                >
                  Active OG
              ...
              <li>
                <button
                  ...
                  onClick={() => {
                    requestSort("organic", "onSale", "productActive", "normal");
                    setButtonActive("5");
                  }}
                >
                  On Sale Organic
